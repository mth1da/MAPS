...
class IngredientFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $mie->setPrice(1);
        $mie->setPhoto("upload/images/ingredients/painmie.jpg");
        $mie->setTypes(
        ...
        $burger->setPrice(1);
        $burger->setPhoto("upload/images/ingredients/burger.jpg");
        $burger->setTypes(
            $this->getReference('pain')
        );
        ...
        $jambon->setPrice(1);
        $jambon->setPhoto("upload/images/ingredients/jambon.jpg");
        $jambon->setTypes(
        ...
        $steak->setPrice(1.5);
        $steak->setPhoto("upload/images/ingredients/steak.webp");
        $steak->setTypes(
            $this->getReference('viande')
        );
        ...
        $saumon->setPrice(1.5);
        $saumon->setPhoto("upload/images/ingredients/saumon.webp");
        $saumon->setTypes(
        ...
        $olive->setPrice(0.2);
        $olive->setPhoto("upload/images/ingredients/olive.jpg");
        $olive->setTypes(
            $this->getReference('crudite')
        );
        ...
        $carotte->setPhoto("upload/images/ingredients/carotte.jpg");
        $carotte->setTypes(
            $this->getReference('crudite')
        );
        ...
        $concombre->setPhoto("upload/images/ingredients/concombre.jpg");
        $concombre->setTypes(
            $this->getReference('crudite')
        );
        ...
        $mais->setPrice(0.2);
        $mais->setPhoto("upload/images/ingredients/mais.jpg");
        $mais->setTypes(
            $this->getReference('crudite')
        );
        ...
        $oeuf->setPrice(0.2);
        $oeuf->setPhoto("upload/images/ingredients/oeuf.jpg");
        $oeuf->setTypes(
            $this->getReference('crudite')
        );
        ...
        $radi->setPrice(0.2);
        $radi->setPhoto("upload/images/ingredients/radis.jpg");
        $radi->setTypes(
            $this->getReference('crudite')
        );
        ...
        $brie->setPrice(0.4);
        $brie->setPhoto("upload/images/ingredients/brie.jpg");
        $brie->setTypes(
            $this->getReference('fromage')
        );
        ...
        $cheddar->setPhoto("upload/images/ingredients/cheddar.jpg");
        $cheddar->setTypes(
            $this->getReference('fromage')
        );
        ...
        $emmental->setPhoto("upload/images/ingredients/emmental.jpg");
        $emmental->setTypes(
            $this->getReference('fromage')
        );
        ...
        $basilic->setPhoto("upload/images/ingredients/basilic.jpg");
        $basilic->setTypes(
        ...
        $cor->setPrice(0.1);
        $cor->setPhoto("upload/images/ingredients/coriandre.jpg");
        $cor->setTypes(
            $this->getReference('plante')
        );
        $manager->persist($cor);
        ...
        $menthe->setPrice(0.1);
        $menthe->setPhoto("upload/images/ingredients/menthe.jpg");
        $menthe->setTypes(
            $this->getReference('plante')
        );
        ...
        $oignon->setPrice(0.1);
        $oignon->setPhoto("upload/images/ingredients/oignon.jpg");
        $oignon->setTypes(
            $this->getReference('plante')
        );
        ...
        $curry->setPrice(0.1);
        $curry->setPhoto("upload/images/ingredients/curry.jpg");
        $curry->setTypes(
        ...
        $poivre->setPhoto("upload/images/ingredients/poivre.webp");
        $poivre->setTypes(
            $this->getReference('epice')
        );
        ...
        $papri->setPrice(0.1);
        $papri->setPhoto("upload/images/ingredients/paprika.webp");
        $papri->setTypes(
            $this->getReference('epice')
        );
        ...
        $curcuma->setPhoto("upload/images/ingredients/curcuma.jpg");
        $curcuma->setTypes(
            $this->getReference('epice')
        );
        ...
        $soja->setPrice(0.1);
        $soja->setPhoto("upload/images/ingredients/soja.jpg");
        $soja->setTypes(
        ...
        $bbq->setPrice(0.1);
        $bbq->setPhoto("upload/images/ingredients/bbq.jpg");
        $bbq->setTypes(
            $this->getReference('sauce')
        );
        $manager->persist($bbq);
        ...
        $wasabi->setPrice(0.1);
        $wasabi->setPhoto("upload/images/ingredients/wasabi.jpg");
        $wasabi->setTypes(
            $this->getReference('sauce')
        );
        ...
        $moutarde->setPhoto("upload/images/ingredients/moutarde.jpg");
        $moutarde->setTypes(
            $this->getReference('sauce')
        );
        ...
        $mayo->setPrice(0.1);
        $mayo->setPhoto("upload/images/ingredients/mayo.jpg");
        $mayo->setTypes(
            $this->getReference('sauce')
        );
        ...
        $ketchup->setPhoto("upload/images/ingredients/ketchup.jpg");
        $ketchup->setTypes(
            $this->getReference('sauce')
        );
